...
def post_worker_init(worker):
    try:
        ...
        from app.tasks.maps_scheduler import start_maps_scheduler
        ...
        start_maps_scheduler(app)
        worker.log.info("Scheduler de reservas NAP (hilo) iniciado en este proceso")
